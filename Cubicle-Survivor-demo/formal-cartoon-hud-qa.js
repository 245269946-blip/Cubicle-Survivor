...
check(report.bossCacheRegression.coherentSingleCharacter && report.bossCacheRegression.assetQuery === "v=315-formal-4"
...
check(combat.includes('id.indexOf("formal_") === 0 || id.indexOf("cartoon_") === 0 ? "v=315-formal-4"')
...
check(index.includes('generated-skin.css?v=52') && index.includes('systems.js?v=98')
