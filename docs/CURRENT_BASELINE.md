...
- **Demo V2**: the newly approved production target documented in `docs/DEMO_V2_PRODUCTION_BRIEF.md`. Its isolated Phase A, Phase B, Demo V2.1 Marker and Demo V2.2 Thermos tests have separate runnable entries; none has replaced the active Demo V1 package.
